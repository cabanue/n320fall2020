...
scene.registerAfterRender(function(){
    if(ball.intersectsMesh(goal, false)) {
        ...
        //set the goal to a different random position
...
function createScene() {
    ...
    //setup ground for ball to be on
    var ground = BABYLON.MeshBuilder.CreateGround("ground", {height: 20, width: 20, subdivision: 4}, scene);
    ground.position.y = -3;
    ground.position.z = 9;
    ...
    particleSystem.particleTexture = new BABYLON.Texture("images/smoke.png", scene);
